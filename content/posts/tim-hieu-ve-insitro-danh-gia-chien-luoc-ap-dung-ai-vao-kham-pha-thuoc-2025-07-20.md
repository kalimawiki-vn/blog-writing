...
AI được đánh giá là có tiềm năng giải quyết những bài toán này: phát hiện mẫu sinh học nhanh chóng, phân tích dữ liệu quy mô lớn, mô phòng hiệu quả và độc tính của thuốc trước khi thử nghiệm lâm sàng. Tuy nhiên, tính đặc thù phức tạp của sinh học con người khiến những tiên đoán của AI không dễ dàng chuyển thành hiệu quả lâm sàng thuyết phục.

## Người tạo tầm nhìn cho Insitro: Hành trình của Daphne Koller
...
Trong bối cảnh này, ngay cả những công ty được tài trợ tốt như Insitro cũng không thể đứng ngoài. Áp lực không chỉ nằm ở việc có mô hình tốt, mà là chứng minh rằng mô hình đó tạo ra khác biệt rõ ràng trong thế giới thực.
...
## Phân tích pipeline: Dự án, tiến độ và tính minh bạch
...
Mặc dù Insitro đã công bố đang có nhiều chương trình hoạt động ở các lĩnh vực trên, nhưng một trong những vấn đề lớn nhất mà các nhà đầu tư và giới chuyên môn lo ngại là thiếu minh bạch trong pipeline – cụ thể:
...
- Có dữ liệu phân tử học, hình ảnh tế bào và dữ liệu gene phục vụ cho mô hình AI
...
**2. Công ty phần mềm sinh học (Software-first)**

- Đại diện: Exscientia (trước khi sáp nhập), Atomwise
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------- |
| **[Recursion Pharmaceuticals](https://kalimawiki.vercel.app/posts/recursion-pharmaceuticals_-an-analytical-overview-of-innovation-in-tech-driven-biotech-2025-06-20/)** | Nền tảng hình ảnh tế bào quy mô lớn, pipeline lâm sàng rõ ràng, đối tác như Bayer và Sanofi | Chi phí vận hành lớn, chưa có thuốc được phê duyệt  |
| **[Insilico Medicine](https://kalimawiki.vercel.app/posts/in-depth-with-insilico-medicine_-redefining-pharma-through-artificial-intelligence-2025-06-17/)**             | Đã có thuốc AI bước vào thử nghiệm lâm sàng pha 2a, minh bạch pipeline                      | Chủ yếu tập trung vào bệnh ung thư và xơ hóa        |
| **[BenevolentAI](https://kalimawiki.vercel.app/posts/benevolentai_-revolutionizing-drug-discovery-with-artificial-intelligence-2025-07-03/)**                           | Khoa học tính toán mạnh, hợp tác với AstraZeneca                                            | Giá cổ phiếu sụt giảm mạnh, bị nghi ngờ về thực thi |
| **[Atomwise](https://kalimawiki.vercel.app/posts/the-structure-speaks-atomwises-unique-ai-approach-to-drug-design-2025-07-06/)**                                        | Tập trung thiết kế phân tử nhỏ bằng AI                                                      | Thiếu tiến triển lâm sàng rõ rệt                    |
...
- Mô hình vòng lặp AI – sinh học cho phép cải tiến liên tục
...
- *Cơ hội*: Nếu Insitro có thể chứng minh mô hình của mình mang lại kết quả lâm sàng, họ sẽ nổi lên như người dẫn đầu và có thể định hình chuẩn mực mới cho ngành.
- *Rủi ro*: Nếu không có dữ liệu mạnh trong 2–3 năm tới, công ty có thể rơi vào khủng hoảng định vị, khó tiếp cận thêm vốn, và dễ bị “nuốt chửng” bởi đối thủ có pipeline mạnh hơn.
...
### Công nghệ tế bào gốc cảm ứng đa năng (iPSC)
...
- **Dữ liệu đa phương thức**: Việc tổng hợp dữ liệu từ nhiều nguồn khác nhau – như gene, hóa học, hình ảnh, và kiểu hình tế bào – đòi hỏi kiến trúc AI đặc biệt để xử lý đồng thời các định dạng không đồng nhất.
...
### Cân nhắc cho FDA và các cơ quan quản lý
...
- **Cơ hội từ thị trường khổng lồ**: Chi phí trung bình để phát triển một loại thuốc mới với việc áp dụng công nghệ AI (~2,6 tỷ USD) là tiền đề để phát triển một phương pháp cạnh tranh tối ưu nhất.
...
### Một số tình huống khả năng có thể xảy ra
...
1. Đẩy nhanh xác thực lâm sàng: Quản lý chặt chẽ thời gian và tài nguyên để sớm đưa được ứng viên thuốc vào thử nghiệm trên người.
...
Câu hỏi không còn là liệu Insitro có phải là một công ty ấn tượng hay không – điều đó không ai nghi ngờ. Câu hỏi đặt ra là: công nghệ ấn tượng có đủ sức vượt qua những thách thức cơ bản đã khiến toàn ngành AI dược phẩm chưa thể chứng minh tính hiệu quả thực sự của mình hay không. Thời gian đang chống lại họ – và toàn ngành đang theo dõi sát sao.